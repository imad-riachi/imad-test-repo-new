...
module.exports = {
  ...
  dbCredentials: {
    ...
    host: "db.mbvzkyklmhzpeernrope.supabase.co",
    port: 5432,
    database: "postgres", 
    user: "postgres",
    ...
    // connectionString: "postgresql://postgres.mbvzkyklmhzpeernrope:postgres@aws-0-us-west-1.pooler.supabase.com:5432/postgres?options=project%3Dmbvzkyklmhzpeernrope",
    */
  },
};
